...
def available_parking():
    ...
    #f5.pack_forget()
def login_1():
    tkMessageBox.showinfo("Order info","Order done")
'''def login(pas,user):
...
'''f=tk.Label(master)
f.config(text = "Login Page",bg="black",fg="white")
f.pack(anchor=W)'''
f1 = tk.Frame(master)
l1 = tk.Label(f1, text="pass Word")
l1.pack(side=LEFT)
#v=StringVar()
E1=Entry(f1,bd=5)#textvariable=v)
E1.pack(side=LEFT)
#v=StringVar()
#v=E1.get()
f4=tk.Frame(master)
...
l.pack(side=LEFT)
#v1=StringVar()
a1=Entry(f4,bd=5)#textvariable=v1)
a1.pack(side=RIGHT)
#v1=StringVar()
#v1=a1.get()
#checkbox = Checkbutton(f4, text="Keep me logged in")
#checkbox.pack(side=BOTTOM)
f3=tk.Frame(master)
B1 = tk.Button(f3, text="New User",bg="blue",command=register_page)
b2=tk.Button(f3,text="Login Now",bg="blue")#,command=login(v,v1))
b2.pack(side=BOTTOM)
B1.pack()
B4 = tk.Button(f3, text="Available Parking",bg="red",fg="green", command=available_parking)
B4.pack(side=LEFT)
f3.pack()
f4.pack(side=TOP)
...
l6=tk.Entry(f5,bd=5)
l6.pack(side=LEFT   )
b2 = tk.Button(f2, text="Return Login Page",fg="red",command=login_page)
b2.pack(anchor= S)
f5.pack(side=BOTTOM)
...
b9.pack()
B5=tk.Button(f6, text="Order",bg="blue",command=login_1)
B5.pack()
b10 = tk.Button(f6,fg="red", text="Return Login Page", command=login_page)
b10.pack()
# show first frame
f1.pack()
#f2.pack()
